...
<div>
	...
	<div class="container" style="margin-top:80px;">
				<div id="fm-main">
					<form class="col-md-12" action="/infocrawler/calScores" method="post"> 
					 ...
					 <div class="col-md-12" style="margin:10px;border-bottom:1px dashed #ddd;">
								...
								<ul class="list-group"  id="detail-info" >
									...
									<div style="margin-top:10px">
										...
										<div class="radio-inline col-md-3">
											<label>
	    										<input type="radio" name="options${status.index + 1}" id="optionsRadios1" value="${item.result1}" checked>
	    												${item.result1}
	  											</label>
										</div>
										<div class="radio-inline col-md-3">
	  											<label>
	    											<input type="radio" name="options${status.index + 1}" id="optionsRadios2" value="${item.result2}">
	   													${item.result2}
	  											</label>
										</div>
										<div class="radio-inline col-md-3">
	  											<label>
	    											<input type="radio" name="options${status.index + 1}" id="optionsRadios3" value="${item.result3}" >
	   													${item.result3}
	  											</label>
										</div>
										<div class="radio-inline ">
	  											<label>
	    											<input type="radio" name="options${status.index + 1}" id="optionsRadios4" value="${item.result4}" >
	   													${item.result4}
	  											</label>
										</div>
										</li>
						...
						<div class="col-md-12" style="margin-top:10px;border-bottom:1px solid #ddd;" >
							...
							<div class="col-md-12" style="margin-left:8px;">					
									...
									<div class="col-md-12" >
										<textarea class="col-md-11" name="positive1" rows="5" placeholder="请将内容填写在此"></textarea>
									</div>
									</div>
									...
									<div class="col-md-12">
										<textarea class="col-md-11" rows="5" name="positive2" placeholder="请将内容填写在此"></textarea>
									</div>
									</div>
							</div>
