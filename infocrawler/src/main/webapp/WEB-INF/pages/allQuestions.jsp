...
<div>
	...
	<div class="modal fade" id="myModal" tabindex="-1"  role="dialog" aria-labelledby="gridSystemModalLabel">
	 <form action="/infocrawler/addQuestion" method="post" role="form"  accept-charset="utf-8">
      <div class="modal-dialog" role="document">
    	<div class="modal-content">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	        <h4 class="modal-title" id="gridSystemModalLabel">提出问题</h4>
	      </div>
	      <div class="modal-body">
	        <div class="container-fluid">
	        
	         	 <div class="form-group col-md-12">
					<input type="text" class="form-control" name="questionname"  placeholder="问题">
				 </div>
						...
						<table class="table table-condensed">
						   <thead>
						      <tr>
						         ...
						         <th>提问者</th>
						         <th style="text-align: center">回答次数</th>
						      </tr>
						   </thead>
						   <tbody>
						   		
						   		<c:forEach var="item" items="${questionInfoList }">
									 <tr>
								         <td><a href="/infocrawler/showQuestionDetail?questionid=${item.id}">${item.questionname}</a></td>
								         <td>${item.description}</td>
								         <td style="text-align: center">${item.time}</td>
								         <td>${item.askusername}</td>
								         <td style="text-align: center">
												<span class="badge">${item.answernum} </span>								       
								         </td>
						     		 </tr>
