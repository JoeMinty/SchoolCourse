						...
						<table class="table table-condensed">
						   <thead>
						      <tr>
						         ...
						         <th style="text-align: center">上传学生</th>
						         <th style="text-align: center">上传时间</th>
						         <th style="text-align: center">批阅主观题</th>
						      </tr>
						   </thead>
						   <tbody>
						   		...
						   		<c:forEach var="item" items="${personalExamList }" varStatus="status">
						     		  <tr>
								         ...
								         <td style="text-align: center">
											<a href="/infocrawler/initOneEverExamOnlyPositive?examid=${item.id}"><span class="glyphicon glyphicon-pencil"></span></a>						       
								         </td>
						     		 </tr>
						  	  </c:forEach>	
