						...
						<table class="table table-condensed">
						   <thead>
						      <tr>
						         ...
						         <th style="text-align: center">客观题得分</th>
						         <th style="text-align: center">主观题得分</th>
						   ...
						   <tbody>
						   		...
						   		<c:forEach var="item" items="${personalExamList }" varStatus="status">
									 <tr>
								         <td style="text-align: center">${status.index + 1}</td>
								         <td style="text-align: center">${item.choosescore}分</td>
								         <td style="text-align: center">${item.tempresult}</td>
								         <td style="text-align: center">${item.choosescore + item.positive1score + item.positive2score}分</td>
								         <td style="text-align: center">
											<a href="/infocrawler/initOneEverExam?examid=${item.id}"><span class="glyphicon glyphicon-search"></span></a>						       
								         </td>
						     		 </tr>
